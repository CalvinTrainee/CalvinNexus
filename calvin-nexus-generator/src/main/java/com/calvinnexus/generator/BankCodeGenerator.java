package com.calvinnexus.generator;
...
public class BankCodeGenerator {
	...
	public static void main(String[] args) {
		...
		gc.setOutputDir(System.getProperty("user.dir") + "/calvin-nexus-generator/src/main/java");
		gc.setAuthor("itcast");
		gc.setOpen(false);
		...
		pc.setParent("com.calvinnexus.rocketmq");
