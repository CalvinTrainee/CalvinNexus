package com.calvinnexus.media.service.impl;
...
import com.calvinnexus.media.mapper.MediaFilesMapper;
...
import com.calvinnexus.media.service.MediaFileService;
import io.minio.*;
...
public class MediaFileServiceImpl implements MediaFileService {
    ...
    public UploadFileResultDto uploadFile(Long companyId, UploadFileParamsDto uploadFileParamsDto, String localFilePath) {
        ...
        if (!result) {
            CalvinNexusException.cast("上传文件失败");
        }
        //入库文件信息
        MediaFiles mediaFiles = currentProxy.addMediaFilesToDb(companyId, fileMd5, uploadFileParamsDto, bucket_mediafiles, objectName);
        if (mediaFiles == null) {
            CalvinNexusException.cast("文件上传后保存信息失败");
        }
        //准备返回的对象
     ...
     * @return com.calvinnexus.media.model.po.MediaFiles
