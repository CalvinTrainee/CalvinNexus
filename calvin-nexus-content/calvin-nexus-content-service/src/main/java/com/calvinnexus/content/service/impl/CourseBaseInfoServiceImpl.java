...
import com.calvinnexus.base.exception.CalvinNexusException;
...
import com.calvinnexus.content.mapper.CourseMarketMapper;
...
import com.calvinnexus.content.model.po.CourseMarket;
...
public class CourseBaseInfoServiceImpl implements CourseBaseInfoService {
    ...
    public PageResult<CourseBase> queryCourseBaseList(PageParams pageParams, QueryCourseParamsDto courseParamsDto) {
        ...
        //根据项目审核状态查询 course_base.audit_status = ?
...
//            CalvinNexusException.cast("项目名称为空");
//        }
//
...
//            throw new RuntimeException("项目等级为空");
//        }
//
...
//        courseBaseNew.setDescription(dto.getDescription());
        ...
        if (insert <= 0) {
            throw new RuntimeException("添加项目失败");
        }

        //向项目营销系courese_market写入数据
    ...
    public CourseBaseInfoDto getCourseBaseInfo(Long courseId) {
        ...
        //todo：项目分类的名称设置到courseBaseInfoDto
    ...
    public CourseBaseInfoDto updateCourseBase(Long companyId, EditCourseDto editCourseDto) {
        ...
        CourseBase courseBase = courseBaseMapper.selectById(courseId);
        if (courseBase == null) {
            CalvinNexusException.cast("项目不存在");
        }
        ...
        if (!companyId.equals(courseBase.getCompanyId())) {
            CalvinNexusException.cast("本机构只能修改本机构的项目");
        }
        ...
        if (i <= 0) {
            CalvinNexusException.cast("修改项目失败");
        }
        //更新营销信息
        //todo:更新营销信息
        //查询项目信息
    ...
    private int saveCourseMarket(CourseMarket courseMarketNew) {
        ...
        //如果项目收费，价格没有填写也需要抛出异常
        if (charge.equals("201001")) {
            if (courseMarketNew.getPrice() == null || courseMarketNew.getPrice().floatValue() <= 0) {
//               throw new RuntimeException("项目的价格不能为空并且必须大于0");
                CalvinNexusException.cast("项目的价格不能为空并且必须大于0");
            }
        }
