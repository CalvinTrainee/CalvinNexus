 ...
 */
@Data
@ApiModel(value = "AddCourseDto", description = "新增项目基本信息")
public class AddCourseDto {

    @NotEmpty(message = "新增项目名称不能为空", groups = {ValidationGroups.Inster.class})
    @NotEmpty(message = "修改项目名称不能为空", groups = {ValidationGroups.Update.class})
